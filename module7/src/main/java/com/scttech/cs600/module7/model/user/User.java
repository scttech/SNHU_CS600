package com.scttech.cs600.module7.model.user;
 ...
 * docs/module7/ddd/domain-model.puml). Deliberately minimal: enough to authenticate and
...
public class User {
    ...
    /**
     * The audit hook this story exists to build (see docs/module7/ddd/login-sequence.puml)
