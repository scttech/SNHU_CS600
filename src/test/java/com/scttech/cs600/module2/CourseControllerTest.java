...
class CourseControllerTest {
    ...
    void listsAllCourses() throws Exception {
        given(courseRepository.findAll()).willReturn(List.of(existingCourse(UUID.randomUUID(), "CS-600", "Data Structures & Algorithms", 3)));
    ...
    void getsACourseById() throws Exception {
        ...
        given(courseRepository.findById(id)).willReturn(Optional.of(existingCourse(id, "CS-600", "Data Structures & Algorithms", 3)));
    ...
    void updatesAnExistingCourse() throws Exception {
        ...
        mockMvc.perform(put("/api/courses/{id}", id)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(new Course("CS-600", "New Title", 4))))
                .andExpect(status().isOk())
